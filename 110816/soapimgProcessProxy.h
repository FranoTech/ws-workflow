	...
	{ soap = soap_new(); endpoint = "http://localhost/cgi-bin/imgProcessServer"; if (soap && !soap->namespaces) { static const struct Namespace namespaces[] = 
{
	...
	virtual int ns__MatToJPG(char *InputFilename, char *&OutputFilename) { return soap ? soap_call_ns__MatToJPG(soap, endpoint, NULL, InputFilename, OutputFilename) : SOAP_EOM; };
