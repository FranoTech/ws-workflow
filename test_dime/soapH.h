...
#ifndef soap_write_ns__ImageData
#define soap_write_ns__ImageData(soap, data) ( soap_begin_send(soap) || ((data)->soap_serialize(soap), 0) || (data)->soap_put(soap, "ns:ImageData", NULL) || soap_end_send(soap) )
#endif


#ifndef soap_read_ns__ImageData
...
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__MatToIpl1Ch(struct soap*, struct ns__MatToIpl1Ch *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__MatToIpl1Ch(struct soap*, const struct ns__MatToIpl1Ch *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__MatToIpl1Ch(struct soap*, const char*, int, const struct ns__MatToIpl1Ch *, const char*);
SOAP_FMAC3 struct ns__MatToIpl1Ch * SOAP_FMAC4 soap_in_ns__MatToIpl1Ch(struct soap*, const char*, struct ns__MatToIpl1Ch *, const char*);

#ifndef soap_write_ns__MatToIpl1Ch
#define soap_write_ns__MatToIpl1Ch(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__MatToIpl1Ch(soap, data), 0) || soap_put_ns__MatToIpl1Ch(soap, data, "ns:MatToIpl1Ch", NULL) || soap_end_send(soap) )
#endif


SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__MatToIpl1Ch(struct soap*, const struct ns__MatToIpl1Ch *, const char*, const char*);

#ifndef soap_read_ns__MatToIpl1Ch
#define soap_read_ns__MatToIpl1Ch(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__MatToIpl1Ch(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 struct ns__MatToIpl1Ch * SOAP_FMAC4 soap_get_ns__MatToIpl1Ch(struct soap*, struct ns__MatToIpl1Ch *, const char*, const char*);

#define soap_new_ns__MatToIpl1Ch(soap, n) soap_instantiate_ns__MatToIpl1Ch(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__MatToIpl1Ch(soap, p) soap_delete(soap, p)

SOAP_FMAC1 struct ns__MatToIpl1Ch * SOAP_FMAC2 soap_instantiate_ns__MatToIpl1Ch(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__MatToIpl1Ch(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE_ns__MatToIpl1ChResponse
#define SOAP_TYPE_ns__MatToIpl1ChResponse (20)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__MatToIpl1ChResponse(struct soap*, struct ns__MatToIpl1ChResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__MatToIpl1ChResponse(struct soap*, const struct ns__MatToIpl1ChResponse *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__MatToIpl1ChResponse(struct soap*, const char*, int, const struct ns__MatToIpl1ChResponse *, const char*);
SOAP_FMAC3 struct ns__MatToIpl1ChResponse * SOAP_FMAC4 soap_in_ns__MatToIpl1ChResponse(struct soap*, const char*, struct ns__MatToIpl1ChResponse *, const char*);

#ifndef soap_write_ns__MatToIpl1ChResponse
#define soap_write_ns__MatToIpl1ChResponse(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__MatToIpl1ChResponse(soap, data), 0) || soap_put_ns__MatToIpl1ChResponse(soap, data, "ns:MatToIpl1ChResponse", NULL) || soap_end_send(soap) )
#endif


SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__MatToIpl1ChResponse(struct soap*, const struct ns__MatToIpl1ChResponse *, const char*, const char*);

#ifndef soap_read_ns__MatToIpl1ChResponse
#define soap_read_ns__MatToIpl1ChResponse(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__MatToIpl1ChResponse(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 struct ns__MatToIpl1ChResponse * SOAP_FMAC4 soap_get_ns__MatToIpl1ChResponse(struct soap*, struct ns__MatToIpl1ChResponse *, const char*, const char*);

#define soap_new_ns__MatToIpl1ChResponse(soap, n) soap_instantiate_ns__MatToIpl1ChResponse(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__MatToIpl1ChResponse(soap, p) soap_delete(soap, p)

SOAP_FMAC1 struct ns__MatToIpl1ChResponse * SOAP_FMAC2 soap_instantiate_ns__MatToIpl1ChResponse(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__MatToIpl1ChResponse(struct soap*, int, int, void*, size_t, const void*, size_t);
...
#ifndef soap_write_ns__Ipl1ChToMat
#define soap_write_ns__Ipl1ChToMat(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__Ipl1ChToMat(soap, data), 0) || soap_put_ns__Ipl1ChToMat(soap, data, "ns:Ipl1ChToMat", NULL) || soap_end_send(soap) )
#endif


SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__Ipl1ChToMat(struct soap*, const struct ns__Ipl1ChToMat *, const char*, const char*);

#ifndef soap_read_ns__Ipl1ChToMat
...
#ifndef soap_write_ns__Ipl1ChToMatResponse
#define soap_write_ns__Ipl1ChToMatResponse(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__Ipl1ChToMatResponse(soap, data), 0) || soap_put_ns__Ipl1ChToMatResponse(soap, data, "ns:Ipl1ChToMatResponse", NULL) || soap_end_send(soap) )
#endif
...
#ifndef soap_read_ns__Ipl1ChToMatResponse
...
#define soap_write_ns__getImage(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__getImage(soap, data), 0) || soap_put_ns__getImage(soap, data, "ns:getImage", NULL) || soap_end_send(soap) )
#endif
...
#define soap_write_ns__getImageResponse(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__getImageResponse(soap, data), 0) || soap_put_ns__getImageResponse(soap, data, "ns:getImageResponse", NULL) || soap_end_send(soap) )
#endif
