...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__ImgData(struct soap*, const char*, int, const ns__ImgData *, const char*);
SOAP_FMAC3 ns__ImgData * SOAP_FMAC4 soap_in_ns__ImgData(struct soap*, const char*, ns__ImgData *, const char*);

#define soap_write_ns__ImgData(soap, data) ( soap_begin_send(soap) || ((data)->soap_serialize(soap), 0) || (data)->soap_put(soap, NULL, NULL) || soap_end_send(soap) )


#define soap_read_ns__ImgData(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__ImgData(soap, data, NULL, NULL) || soap_end_recv(soap) )

SOAP_FMAC3 ns__ImgData * SOAP_FMAC4 soap_get_ns__ImgData(struct soap*, ns__ImgData *, const char*, const char*);

#define soap_new_ns__ImgData(soap, n) soap_instantiate_ns__ImgData(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__ImgData(soap, p) soap_delete(soap, p)

SOAP_FMAC1 ns__ImgData * SOAP_FMAC2 soap_instantiate_ns__ImgData(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__ImgData(struct soap*, int, int, void*, size_t, const void*, size_t);
