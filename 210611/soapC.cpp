...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.7.17 2011-06-23 04:58:35 GMT")
...
SOAP_FMAC3 void * SOAP_FMAC4 soap_getelement(struct soap *soap, int *type)
{
	...
	case SOAP_TYPE_ns__ImgData:
		return soap_in_ns__ImgData(soap, NULL, NULL, "ns:ImgData");
	...
	{	const char *t = soap->type;
		if (!*t)
			t = soap->tag;
		if (!soap_match_tag(soap, t, "ns:ImgData"))
		{	*type = SOAP_TYPE_ns__ImgData;
			return soap_in_ns__ImgData(soap, NULL, NULL, NULL);
		}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_putelement(struct soap *soap, const void *ptr, const char *tag, int id, int type)
{
	...
	case SOAP_TYPE_ns__ImgData:
		return ((ns__ImgData *)ptr)->soap_out(soap, tag, id, "ns:ImgData");
	case SOAP_TYPE_ns__MorphOpen:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	{
	case SOAP_TYPE_ns__ImgData:
		((ns__ImgData *)ptr)->soap_serialize(soap);
		break;
	case SOAP_TYPE_ns__MorphOpen:
...
SOAP_FMAC3 void * SOAP_FMAC4 soap_instantiate(struct soap *soap, int t, const char *type, const char *arrayType, size_t *n)
{
	...
	{
	case SOAP_TYPE_ns__ImgData:
		return (void*)soap_instantiate_ns__ImgData(soap, -1, type, arrayType, n);
	case SOAP_TYPE_ns__Ipl1ChToMat:
...
{	switch (p->type)
	...
	case SOAP_TYPE_ns__ImgData:
		if (p->size < 0)
			SOAP_DELETE((ns__ImgData*)p->ptr);
		else
			SOAP_DELETE_ARRAY((ns__ImgData*)p->ptr);
		break;
	case SOAP_TYPE_ns__Ipl1ChToMat:
		if (p->size < 0)
...
void ns__ImgData::soap_default(struct soap *soap)
{
	(void)soap; /* appease -Wall -Werror */
	soap_default_int(soap, &this->ns__ImgData::__imgHeight);
	soap_default_int(soap, &this->ns__ImgData::__imgWidth);
	soap_default_int(soap, &this->ns__ImgData::__sharedKey);
}

void ns__ImgData::soap_serialize(struct soap *soap) const
{
	(void)soap; /* appease -Wall -Werror */
}

int ns__ImgData::soap_out(struct soap *soap, const char *tag, int id, const char *type) const
{
	return soap_out_ns__ImgData(soap, tag, id, this, type);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__ImgData(struct soap *soap, const char *tag, int id, const ns__ImgData *a, const char *type)
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__ImgData), type))
		return soap->error;
	if (soap_out_int(soap, "-imgHeight", -1, &(a->ns__ImgData::__imgHeight), ""))
		return soap->error;
	if (soap_out_int(soap, "-imgWidth", -1, &(a->ns__ImgData::__imgWidth), ""))
		return soap->error;
	if (soap_out_int(soap, "-sharedKey", -1, &(a->ns__ImgData::__sharedKey), ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}

void *ns__ImgData::soap_in(struct soap *soap, const char *tag, const char *type)
{	return soap_in_ns__ImgData(soap, tag, this, type);
}

SOAP_FMAC3 ns__ImgData * SOAP_FMAC4 soap_in_ns__ImgData(struct soap *soap, const char *tag, ns__ImgData *a, const char *type)
{
	(void)type; /* appease -Wall -Werror */
	if (soap_element_begin_in(soap, tag, 0, NULL))
		return NULL;
	a = (ns__ImgData *)soap_class_id_enter(soap, soap->id, a, SOAP_TYPE_ns__ImgData, sizeof(ns__ImgData), soap->type, soap->arrayType);
	if (!a)
		return NULL;
	if (soap->alloced)
	{	a->soap_default(soap);
		if (soap->clist->type != SOAP_TYPE_ns__ImgData)
		{	soap_revert(soap);
			*soap->id = '\0';
			return (ns__ImgData *)a->soap_in(soap, tag, type);
		}
	}
	size_t soap_flag___imgHeight1 = 1;
	size_t soap_flag___imgWidth1 = 1;
	size_t soap_flag___sharedKey1 = 1;
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag___imgHeight1 && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_int(soap, "-imgHeight", &(a->ns__ImgData::__imgHeight), "xsd:int"))
				{	soap_flag___imgHeight1--;
					continue;
				}
			if (soap_flag___imgWidth1 && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_int(soap, "-imgWidth", &(a->ns__ImgData::__imgWidth), "xsd:int"))
				{	soap_flag___imgWidth1--;
					continue;
				}
			if (soap_flag___sharedKey1 && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_int(soap, "-sharedKey", &(a->ns__ImgData::__sharedKey), "xsd:int"))
				{	soap_flag___sharedKey1--;
					continue;
				}
	...
	{	a = (ns__ImgData *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__ImgData, 0, sizeof(ns__ImgData), 0, soap_copy_ns__ImgData);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag___imgHeight1 > 0 || soap_flag___imgWidth1 > 0 || soap_flag___sharedKey1 > 0))
...
int ns__ImgData::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	register int id = soap_embed(soap, (void*)this, NULL, 0, tag, SOAP_TYPE_ns__ImgData);
	if (this->soap_out(soap, tag?tag:"ns:ImgData", id, type))
		return soap->error;
	return soap_putindependent(soap);
}

void *ns__ImgData::soap_get(struct soap *soap, const char *tag, const char *type)
{
	return soap_get_ns__ImgData(soap, this, tag, type);
}

SOAP_FMAC3 ns__ImgData * SOAP_FMAC4 soap_get_ns__ImgData(struct soap *soap, ns__ImgData *p, const char *tag, const char *type)
{
	if ((p = soap_in_ns__ImgData(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 ns__ImgData * SOAP_FMAC2 soap_instantiate_ns__ImgData(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_ns__ImgData(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_ns__ImgData, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(ns__ImgData);
		if (size)
			*size = sizeof(ns__ImgData);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(ns__ImgData[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(ns__ImgData);
	}
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (ns__ImgData*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__ImgData(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying ns__ImgData %p -> %p\n", q, p));
	*(ns__ImgData*)p = *(ns__ImgData*)q;
}
...
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->dataInput.ns__ImgData::soap_default(soap);
...
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->dataInput.soap_serialize(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__BinaryThreshold(struct soap *soap, const char *tag, int id, const struct ns__BinaryThreshold *a, const char *type)
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__BinaryThreshold), type))
		return soap->error;
	if (a->dataInput.soap_out(soap, "dataInput", -1, ""))
		return soap->error;
...
SOAP_FMAC3 struct ns__BinaryThreshold * SOAP_FMAC4 soap_in_ns__BinaryThreshold(struct soap *soap, const char *tag, struct ns__BinaryThreshold *a, const char *type)
{
	...
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_dataInput && soap->error == SOAP_TAG_MISMATCH)
				if (a->dataInput.soap_in(soap, "dataInput", "ns:ImgData"))
				{	soap_flag_dataInput--;
					continue;
				}
	...
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_dataInput > 0 || soap_flag_threshold > 0 || soap_flag_maxValue > 0))
	{	soap->error = SOAP_OCCURS;
		return NULL;
	}
	return a;
