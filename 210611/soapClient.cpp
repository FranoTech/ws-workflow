...
SOAP_SOURCE_STAMP("@(#) soapClient.cpp ver 2.7.17 2011-06-23 04:58:35 GMT")
...
{	struct ns__BinaryThreshold soap_tmp_ns__BinaryThreshold;
	if (!soap_endpoint)
		soap_endpoint = "http://localhost/cgi-bin/imgSrv";
	soap->encodingStyle = "";
	soap_tmp_ns__BinaryThreshold.dataInput = dataInput;
