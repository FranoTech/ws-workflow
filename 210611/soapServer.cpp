...
SOAP_SOURCE_STAMP("@(#) soapServer.cpp ver 2.7.17 2011-06-23 04:58:35 GMT")
...
{	struct ns__Ipl1ChToMat soap_tmp_ns__Ipl1ChToMat;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = ns__Ipl1ChToMat(soap, soap_tmp_ns__Ipl1ChToMat.InputFilename, imgData);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
	imgData.soap_serialize(soap);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || imgData.soap_put(soap, "ns:ImgData", "")
...
{	struct ns__BinaryThreshold soap_tmp_ns__BinaryThreshold;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = ns__BinaryThreshold(soap, soap_tmp_ns__BinaryThreshold.dataInput, soap_tmp_ns__BinaryThreshold.threshold, soap_tmp_ns__BinaryThreshold.maxValue, imgData);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
	imgData.soap_serialize(soap);
