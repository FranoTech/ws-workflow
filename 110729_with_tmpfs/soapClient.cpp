...
SOAP_SOURCE_STAMP("@(#) soapClient.cpp ver 2.7.17 2011-07-29 08:17:40 GMT")
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__MatToJPG(struct soap *soap, const char *soap_endpoint, const char *soap_action, char *InputFilename, char *&OutputFilename)
{	struct ns__MatToJPG soap_tmp_ns__MatToJPG;
	struct ns__MatToJPGResponse *soap_tmp_ns__MatToJPGResponse;
	if (!soap_endpoint)
		soap_endpoint = "http://localhost/cgi-bin/imgProcessServer";
	soap->encodingStyle = "";
	soap_tmp_ns__MatToJPG.InputFilename = InputFilename;
	soap_begin(soap);
	soap_serializeheader(soap);
