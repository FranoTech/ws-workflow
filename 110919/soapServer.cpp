...
SOAP_SOURCE_STAMP("@(#) soapServer.cpp ver 2.8.6 2011-12-19 17:32:30 GMT")
...
{	struct ns__dilate soap_tmp_ns__dilate;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = ns__dilate(soap, soap_tmp_ns__dilate.src, soap_tmp_ns__dilate.element, soap_tmp_ns__dilate.iteration, soap_tmp_ns__dilateResponse.OutputMatFilename);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
{	struct ns__scanningCell soap_tmp_ns__scanningCell;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = ns__scanningCell(soap, soap_tmp_ns__scanningCell.inputMatFilename, soap_tmp_ns__scanningCellResponse.outputMatFilename);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
