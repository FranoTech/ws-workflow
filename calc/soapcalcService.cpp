...
{	struct ns__add soap_tmp_ns__add;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->add(soap_tmp_ns__add.a, soap_tmp_ns__add.b, &soap_tmp_double);
	if (soap->error)
		return soap->error;
...
{	struct ns__sub soap_tmp_ns__sub;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->sub(soap_tmp_ns__sub.a, soap_tmp_ns__sub.b, &soap_tmp_double);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
{	struct ns__mul soap_tmp_ns__mul;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->mul(soap_tmp_ns__mul.a, soap_tmp_ns__mul.b, &soap_tmp_double);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
{	struct ns__div soap_tmp_ns__div;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->div(soap_tmp_ns__div.a, soap_tmp_ns__div.b, &soap_tmp_double);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
{	struct ns__pow soap_tmp_ns__pow;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->pow(soap_tmp_ns__pow.a, soap_tmp_ns__pow.b, &soap_tmp_double);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
