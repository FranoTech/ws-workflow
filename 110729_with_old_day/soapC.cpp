...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.7.17 2011-07-29 06:37:44 GMT")
...
SOAP_FMAC3 void * SOAP_FMAC4 soap_getelement(struct soap *soap, int *type)
{
	...
	case SOAP_TYPE_ns__MatToIpl1Ch:
		return soap_in_ns__MatToIpl1Ch(soap, NULL, NULL, "ns:MatToIpl1Ch");
	case SOAP_TYPE_ns__MatToIpl1ChResponse:
		return soap_in_ns__MatToIpl1ChResponse(soap, NULL, NULL, "ns:MatToIpl1ChResponse");
	...
	{	const char *t = soap->type;
		...
		if (!soap_match_tag(soap, t, "ns:MatToIpl1Ch"))
		{	*type = SOAP_TYPE_ns__MatToIpl1Ch;
			return soap_in_ns__MatToIpl1Ch(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "ns:MatToIpl1ChResponse"))
		{	*type = SOAP_TYPE_ns__MatToIpl1ChResponse;
			return soap_in_ns__MatToIpl1ChResponse(soap, NULL, NULL, NULL);
		}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_putelement(struct soap *soap, const void *ptr, const char *tag, int id, int type)
{
	...
	case SOAP_TYPE_ns__MatToIpl1Ch:
		return soap_out_ns__MatToIpl1Ch(soap, tag, id, (const struct ns__MatToIpl1Ch *)ptr, "ns:MatToIpl1Ch");
	case SOAP_TYPE_ns__MatToIpl1ChResponse:
		return soap_out_ns__MatToIpl1ChResponse(soap, tag, id, (const struct ns__MatToIpl1ChResponse *)ptr, "ns:MatToIpl1ChResponse");
	case SOAP_TYPE_ns__Ipl1ChToMat:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	case SOAP_TYPE_ns__BinaryThresholdResponse:
		...
		break;
	case SOAP_TYPE_ns__MatToIpl1Ch:
		soap_serialize_ns__MatToIpl1Ch(soap, (const struct ns__MatToIpl1Ch *)ptr);
		break;
	case SOAP_TYPE_ns__MatToIpl1ChResponse:
		soap_serialize_ns__MatToIpl1ChResponse(soap, (const struct ns__MatToIpl1ChResponse *)ptr);
		break;
	case SOAP_TYPE_ns__Ipl1ChToMat:
...
SOAP_FMAC3 void * SOAP_FMAC4 soap_instantiate(struct soap *soap, int t, const char *type, const char *arrayType, size_t *n)
{
	...
	case SOAP_TYPE_ns__MatToIpl1ChResponse:
		return (void*)soap_instantiate_ns__MatToIpl1ChResponse(soap, -1, type, arrayType, n);
	case SOAP_TYPE_ns__MatToIpl1Ch:
		return (void*)soap_instantiate_ns__MatToIpl1Ch(soap, -1, type, arrayType, n);
	case SOAP_TYPE_ns__BinaryThresholdResponse:
...
{	switch (p->type)
	...
	case SOAP_TYPE_ns__getImageResponse:
		if (p->size < 0)
			SOAP_DELETE((struct ns__getImageResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct ns__getImageResponse*)p->ptr);
		break;
	case SOAP_TYPE_ns__getImage:
		if (p->size < 0)
			SOAP_DELETE((struct ns__getImage*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct ns__getImage*)p->ptr);
		break;
	case SOAP_TYPE_ns__Ipl1ChToMatResponse:
		if (p->size < 0)
	...
	case SOAP_TYPE_ns__MatToIpl1ChResponse:
		if (p->size < 0)
			SOAP_DELETE((struct ns__MatToIpl1ChResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct ns__MatToIpl1ChResponse*)p->ptr);
		break;
	case SOAP_TYPE_ns__MatToIpl1Ch:
		if (p->size < 0)
			SOAP_DELETE((struct ns__MatToIpl1Ch*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct ns__MatToIpl1Ch*)p->ptr);
		break;
	case SOAP_TYPE_ns__BinaryThresholdResponse:
		if (p->size < 0)
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__MatToIpl1Ch(struct soap *soap, struct ns__MatToIpl1Ch *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_string(soap, &a->InputFilename);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__MatToIpl1Ch(struct soap *soap, const struct ns__MatToIpl1Ch *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_string(soap, &a->InputFilename);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__MatToIpl1Ch(struct soap *soap, const char *tag, int id, const struct ns__MatToIpl1Ch *a, const char *type)
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__MatToIpl1Ch), type))
		return soap->error;
	if (soap_out_string(soap, "InputFilename", -1, &a->InputFilename, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
SOAP_FMAC3 struct ns__MatToIpl1Ch * SOAP_FMAC4 soap_in_ns__MatToIpl1Ch(struct soap *soap, const char *tag, struct ns__MatToIpl1Ch *a, const char *type)
{
	size_t soap_flag_InputFilename = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__MatToIpl1Ch *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns__MatToIpl1Ch, sizeof(struct ns__MatToIpl1Ch), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_ns__MatToIpl1Ch(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct ns__MatToIpl1Ch *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__MatToIpl1Ch, 0, sizeof(struct ns__MatToIpl1Ch), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__MatToIpl1Ch(struct soap *soap, const struct ns__MatToIpl1Ch *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_ns__MatToIpl1Ch);
	if (soap_out_ns__MatToIpl1Ch(soap, tag?tag:"ns:MatToIpl1Ch", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct ns__MatToIpl1Ch * SOAP_FMAC4 soap_get_ns__MatToIpl1Ch(struct soap *soap, struct ns__MatToIpl1Ch *p, const char *tag, const char *type)
{
	if ((p = soap_in_ns__MatToIpl1Ch(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct ns__MatToIpl1Ch * SOAP_FMAC2 soap_instantiate_ns__MatToIpl1Ch(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_ns__MatToIpl1Ch(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_ns__MatToIpl1Ch, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct ns__MatToIpl1Ch);
		if (size)
			*size = sizeof(struct ns__MatToIpl1Ch);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct ns__MatToIpl1Ch[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct ns__MatToIpl1Ch);
	}
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct ns__MatToIpl1Ch*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__MatToIpl1Ch(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct ns__MatToIpl1Ch %p -> %p\n", q, p));
	*(struct ns__MatToIpl1Ch*)p = *(struct ns__MatToIpl1Ch*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__MatToIpl1ChResponse(struct soap *soap, struct ns__MatToIpl1ChResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_string(soap, &a->OutputFilename);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__MatToIpl1ChResponse(struct soap *soap, const struct ns__MatToIpl1ChResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_string(soap, &a->OutputFilename);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__MatToIpl1ChResponse(struct soap *soap, const char *tag, int id, const struct ns__MatToIpl1ChResponse *a, const char *type)
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__MatToIpl1ChResponse), type))
		return soap->error;
	if (soap_out_string(soap, "OutputFilename", -1, &a->OutputFilename, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
SOAP_FMAC3 struct ns__MatToIpl1ChResponse * SOAP_FMAC4 soap_in_ns__MatToIpl1ChResponse(struct soap *soap, const char *tag, struct ns__MatToIpl1ChResponse *a, const char *type)
{
	size_t soap_flag_OutputFilename = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__MatToIpl1ChResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns__MatToIpl1ChResponse, sizeof(struct ns__MatToIpl1ChResponse), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_ns__MatToIpl1ChResponse(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct ns__MatToIpl1ChResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__MatToIpl1ChResponse, 0, sizeof(struct ns__MatToIpl1ChResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_OutputFilename > 0))
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__MatToIpl1ChResponse(struct soap *soap, const struct ns__MatToIpl1ChResponse *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_ns__MatToIpl1ChResponse);
	if (soap_out_ns__MatToIpl1ChResponse(soap, tag?tag:"ns:MatToIpl1ChResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct ns__MatToIpl1ChResponse * SOAP_FMAC4 soap_get_ns__MatToIpl1ChResponse(struct soap *soap, struct ns__MatToIpl1ChResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in_ns__MatToIpl1ChResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct ns__MatToIpl1ChResponse * SOAP_FMAC2 soap_instantiate_ns__MatToIpl1ChResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_ns__MatToIpl1ChResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_ns__MatToIpl1ChResponse, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct ns__MatToIpl1ChResponse);
		if (size)
			*size = sizeof(struct ns__MatToIpl1ChResponse);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct ns__MatToIpl1ChResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct ns__MatToIpl1ChResponse);
	}
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct ns__MatToIpl1ChResponse*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__MatToIpl1ChResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct ns__MatToIpl1ChResponse %p -> %p\n", q, p));
	*(struct ns__MatToIpl1ChResponse*)p = *(struct ns__MatToIpl1ChResponse*)q;
}
...
SOAP_FMAC1 struct ns__getImage * SOAP_FMAC2 soap_instantiate_ns__getImage(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct ns__getImage);
		if (size)
			*size = sizeof(struct ns__getImage);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct ns__getImage[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->image.ns__ImageData::soap_default(soap);
}
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_image && soap->error == SOAP_TAG_MISMATCH)
				if (a->image.soap_in(soap, "image", "ns:ImageData"))
				{	soap_flag_image--;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
...
SOAP_FMAC1 struct ns__getImageResponse * SOAP_FMAC2 soap_instantiate_ns__getImageResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct ns__getImageResponse);
		if (size)
			*size = sizeof(struct ns__getImageResponse);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct ns__getImageResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
