...
#define soap_write_ns__MatToIpl1Ch(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__MatToIpl1Ch(soap, data), 0) || soap_put_ns__MatToIpl1Ch(soap, data, NULL, NULL) || soap_end_send(soap) )
...
#define soap_write_ns__MatToIpl1ChResponse(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__MatToIpl1ChResponse(soap, data), 0) || soap_put_ns__MatToIpl1ChResponse(soap, data, NULL, NULL) || soap_end_send(soap) )
