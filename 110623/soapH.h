...
#define soap_write_ns__ImageData(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__ImageData(soap, data), 0) || soap_put_ns__ImageData(soap, data, "ns:ImageData", NULL) || soap_end_send(soap) )
#endif
