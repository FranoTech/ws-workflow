...
SOAP_SOURCE_STAMP("@(#) soapClient.cpp ver 2.7.17 2011-02-27 15:47:08 GMT")
...
{	struct ns__Ipl1ChToMat soap_tmp_ns__Ipl1ChToMat;
	...
	soap_tmp_ns__Ipl1ChToMat.filename = filename;
	soap_begin(soap);
	soap_serializeheader(soap);
...
{	struct ns__MatToIpl1Ch soap_tmp_ns__MatToIpl1Ch;
	...
	soap_tmp_ns__MatToIpl1Ch.filename = filename;
	soap_begin(soap);
	soap_serializeheader(soap);
...
{	struct ns__BinaryThreshold soap_tmp_ns__BinaryThreshold;
	...
	soap_tmp_ns__BinaryThreshold.filename = filename;
	soap_begin(soap);
	soap_serializeheader(soap);
