...
SOAP_SOURCE_STAMP("@(#) soapServer.cpp ver 2.7.17 2011-02-27 15:47:08 GMT")
...
{	struct ns__Ipl1ChToMat soap_tmp_ns__Ipl1ChToMat;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = ns__Ipl1ChToMat(soap, soap_tmp_ns__Ipl1ChToMat.InputFilename, soap_tmp_ns__Ipl1ChToMat.filename, soap_tmp_ns__Ipl1ChToMatResponse.OutputFilename);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
{	struct ns__MatToIpl1Ch soap_tmp_ns__MatToIpl1Ch;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = ns__MatToIpl1Ch(soap, soap_tmp_ns__MatToIpl1Ch.InputFilename, soap_tmp_ns__MatToIpl1Ch.filename, soap_tmp_ns__MatToIpl1ChResponse.OutputFilename);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
{	struct ns__BinaryThreshold soap_tmp_ns__BinaryThreshold;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = ns__BinaryThreshold(soap, soap_tmp_ns__BinaryThreshold.InputFilename, soap_tmp_ns__BinaryThreshold.threshold, soap_tmp_ns__BinaryThreshold.maxValue, soap_tmp_ns__BinaryThreshold.filename, soap_tmp_ns__BinaryThresholdResponse.OutputFilename);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
