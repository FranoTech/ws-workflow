...
/* ns:Output */
class SOAP_CMAC ns__Output
{
public:
	char *outputFilename;	/* SOAP 1.2 RPC return element (when namespace qualified) */	/* optional element of type xsd:string */
	char *anotherOutputFilename;	/* optional element of type xsd:string */
public:
	virtual int soap_type() const { return 7; } /* = unique id SOAP_TYPE_ns__Output */
	...
	virtual void *soap_in(struct soap*, const char*, const char*);
	         ns__Output() { ns__Output::soap_default(NULL); }
	virtual ~ns__Output() { }
};
#endif
...
SOAP_FMAC5 int SOAP_FMAC6 ns__genName(struct soap*, char *InputFilename, char *&OutputFilename);

SOAP_FMAC5 int SOAP_FMAC6 ns__genName2(struct soap*, char *InputFilename, char **OutputFilename);

SOAP_FMAC5 int SOAP_FMAC6 ns__genName3(struct soap*, char *InputFilename, ns__Output &out);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_ns__genName(struct soap*);

SOAP_FMAC5 int SOAP_FMAC6 soap_serve_ns__genName2(struct soap*);

SOAP_FMAC5 int SOAP_FMAC6 soap_serve_ns__genName3(struct soap*);
