...
#define SOAP_TYPE_ns__genName2 (14)
#endif
...
#define soap_write_ns__genName2(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__genName2(soap, data), 0) || soap_put_ns__genName2(soap, data, NULL, NULL) || soap_end_send(soap) )
...
#define SOAP_TYPE_ns__genName2Response (13)
#endif
...
#define soap_write_ns__genName2Response(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__genName2Response(soap, data), 0) || soap_put_ns__genName2Response(soap, data, NULL, NULL) || soap_end_send(soap) )
...
#define SOAP_TYPE_ns__genName (10)
#endif
...
#define soap_write_ns__genName(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__genName(soap, data), 0) || soap_put_ns__genName(soap, data, NULL, NULL) || soap_end_send(soap) )
...
#define SOAP_TYPE_ns__genNameResponse (9)
#endif
...
#define soap_write_ns__genNameResponse(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__genNameResponse(soap, data), 0) || soap_put_ns__genNameResponse(soap, data, NULL, NULL) || soap_end_send(soap) )
