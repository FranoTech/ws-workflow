...
#ifndef soap_write_ns__test
#define soap_write_ns__test(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__test(soap, data), 0) || soap_put_ns__test(soap, data, "ns:test", NULL) || soap_end_send(soap) )
#endif


SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__test(struct soap*, const struct ns__test *, const char*, const char*);

#ifndef soap_read_ns__test
#define soap_read_ns__test(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__test(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 struct ns__test * SOAP_FMAC4 soap_get_ns__test(struct soap*, struct ns__test *, const char*, const char*);

#define soap_new_ns__test(soap, n) soap_instantiate_ns__test(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__test(soap, p) soap_delete(soap, p)
...
#define SOAP_TYPE_ns__testResponse (14)
#endif
...
#ifndef soap_write_ns__testResponse
#define soap_write_ns__testResponse(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__testResponse(soap, data), 0) || soap_put_ns__testResponse(soap, data, "ns:testResponse", NULL) || soap_end_send(soap) )
#endif


SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__testResponse(struct soap*, const struct ns__testResponse *, const char*, const char*);

#ifndef soap_read_ns__testResponse
#define soap_read_ns__testResponse(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__testResponse(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif
...
#define soap_new_ns__testResponse(soap, n) soap_instantiate_ns__testResponse(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__testResponse(soap, p) soap_delete(soap, p)
