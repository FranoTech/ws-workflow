	...
	{ soap = soap_new(); endpoint = "http://localhost/cgi-bin/calcserver"; if (soap && !soap->namespaces) { static const struct Namespace namespaces[] = 
{
	...
	/// Invoke 'test' of service 'calc' and return error code (or SOAP_OK)
	virtual int ns__test(char *s, int i, char **t) { return soap ? soap_call_ns__test(soap, endpoint, NULL, s, i, t) : SOAP_EOM; };
};
#endif
