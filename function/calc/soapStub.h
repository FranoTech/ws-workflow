...
{
public:
	char **t;	/* SOAP 1.2 RPC return element (when namespace qualified) */	/* optional element of type xsd:string */
};
#endif
...
{
public:
	char *s;	/* optional element of type xsd:string */
	int i;	/* required element of type xsd:int */
};
#endif
...
SOAP_FMAC5 int SOAP_FMAC6 ns__test(struct soap*, char *s, int i, char **t);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__test(struct soap *soap, const char *soap_endpoint, const char *soap_action, char *s, int i, char **t);
