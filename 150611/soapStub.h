...
#define SOAP_TYPE_ns__Ipl1ChToMatResponse (13)
/* ns:Ipl1ChToMatResponse */
struct ns__Ipl1ChToMatResponse
{
public:
	int *sharedkey;	/* SOAP 1.2 RPC return element (when namespace qualified) */	/* optional element of type xsd:int */
};
#endif

#ifndef SOAP_TYPE_ns__Ipl1ChToMat
#define SOAP_TYPE_ns__Ipl1ChToMat (14)
/* ns:Ipl1ChToMat */
...
#define SOAP_TYPE_ns__MorphOpenResponse (21)
...
#define SOAP_TYPE_ns__MorphOpen (22)
/* ns:MorphOpen */
