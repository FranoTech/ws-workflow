...
#ifndef soapFeature_DetectionObject_H
#define soapFeature_DetectionObject_H
#include "soapH.h"
...
class Feature_DetectionService : public soap
{    public:
	Feature_DetectionService()
	{ static const struct Namespace namespaces[] =
{
	...
	virtual ~Feature_DetectionService() { };
