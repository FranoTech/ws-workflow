...
#define soap_write_ns__Canny(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__Canny(soap, data), 0) || soap_put_ns__Canny(soap, data, "ns:Canny", NULL) || soap_end_send(soap) )
#endif
...
#define soap_read_ns__Canny(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__Canny(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 struct ns__Canny * SOAP_FMAC4 soap_get_ns__Canny(struct soap*, struct ns__Canny *, const char*, const char*);

#define soap_new_ns__Canny(soap, n) soap_instantiate_ns__Canny(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__Canny(soap, p) soap_delete(soap, p)
...
#define soap_write_ns__CannyResponse(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__CannyResponse(soap, data), 0) || soap_put_ns__CannyResponse(soap, data, "ns:CannyResponse", NULL) || soap_end_send(soap) )
#endif
...
#define soap_read_ns__CannyResponse(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__CannyResponse(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif
...
#define soap_new_ns__CannyResponse(soap, n) soap_instantiate_ns__CannyResponse(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__CannyResponse(soap, p) soap_delete(soap, p)
