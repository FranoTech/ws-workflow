...
#ifndef soapArray_OperationObject_H
#define soapArray_OperationObject_H
#include "soapH.h"
...
class Array_OperationService : public soap
{    public:
	Array_OperationService()
	{ static const struct Namespace namespaces[] =
{
	...
	virtual ~Array_OperationService() { };
