...
public:
	int soap_type() const { return 10; } /* = unique id SOAP_TYPE_ns__findContoursResponse */
};
#endif
...
public:
	int soap_type() const { return 11; } /* = unique id SOAP_TYPE_ns__findContours */
};
#endif
...
public:
	std::string OutputMatFilename;	/* SOAP 1.2 RPC return element (when namespace qualified) */	/* required element of type xsd:string */
public:
	int soap_type() const { return 14; } /* = unique id SOAP_TYPE_ns__resizeResponse */
};
#endif
...
public:
	int soap_type() const { return 15; } /* = unique id SOAP_TYPE_ns__resize */
};
#endif
...
{
public:
	int soap_type() const { return 16; } /* = unique id SOAP_TYPE_SOAP_ENV__Header */
...
public:
	int soap_type() const { return 17; } /* = unique id SOAP_TYPE_SOAP_ENV__Code */
};
#endif
...
public:
	int soap_type() const { return 19; } /* = unique id SOAP_TYPE_SOAP_ENV__Detail */
};
#endif
...
public:
	int soap_type() const { return 22; } /* = unique id SOAP_TYPE_SOAP_ENV__Reason */
};
#endif
...
public:
	int soap_type() const { return 23; } /* = unique id SOAP_TYPE_SOAP_ENV__Fault */
};
#endif
